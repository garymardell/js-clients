...
export declare const getHydrator: (response: OperationResult<any>) => DataHydrator | undefined;
export declare const hydrateRecord: <Shape = any>(response: OperationResult<any>, record: any) => import("./GadgetRecord").GadgetRecordImplementation<Shape> & Shape;
export declare const hydrateRecordArray: <Shape = any>(response: OperationResult<any>, records: Array<any>) => (import("./GadgetRecord").GadgetRecordImplementation<Shape> & Shape)[];
export declare const hydrateConnection: <Shape = any>(response: OperationResult<any>, connection: {
    edges: {
        node: Node;
    }[];
