    ...
    return (0, gql_query_builder_1.query)([
        {
            ...
            variables: {
                ...
                ...(options?.sort && { sort: { value: options?.sort, type: (0, _1.sortTypeName)(modelApiIdentifier) + "!", list: true } }),
                ...(options?.filter && { filter: { value: options?.filter, type: (0, _1.filterTypeName)(modelApiIdentifier) + "!", list: true } }),
