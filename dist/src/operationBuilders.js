...
const actionOperation = (operation, defaultSelection, modelApiIdentifier, variables, options, namespace) => {
    let actionOperation = {
        operation,
        fields: [
            "success",
    ...
    if (selection) {
        actionOperation.fields.push({ [modelApiIdentifier]: (0, _1.fieldSelectionToGQLBuilderFields)(selection) });
    }
    if (namespace) {
        actionOperation = {
            operation: namespace,
