...
export declare const actionOperation: (operation: string, defaultSelection: FieldSelection | null, modelApiIdentifier: string, variables: VariableOptions, options?: SelectionOptions | null | undefined, namespace?: string | null | undefined) => {
    variables: any;
    query: string;
};
