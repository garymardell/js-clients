...
const graphql_live_query_patch_json_patch_1 = require("@n1ru4l/graphql-live-query-patch-json-patch");
            ...
            forwardSubscription: (request) => {
                return {
                    subscribe: (sink) => {
                        const input = { ...request, query: request.query || "" };
                        return {
                            unsubscribe: (0, push_pull_async_iterable_iterator_1.applyAsyncIterableIteratorToSink)((0, graphql_live_query_patch_json_patch_1.applyLiveQueryJSONPatch)((0, push_pull_async_iterable_iterator_1.makeAsyncIterableIteratorFromSink)((sink) => this.baseSubscriptionClient.subscribe(input, sink))), sink),
                        };
                    },
                };
            },
